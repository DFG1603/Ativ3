...
public class Ativ3App {

    private static final Logger log = LoggerFactory.getLogger(Ativ3App.class);

    private final Environment env;

    public Ativ3App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Ativ3App.class);
